...
/*  - recuperare il valore dell'input */
        - richiamare l'input
        const inputDomElement = document.getElementById('idInput')
        -recuperare il value
        const km = parseInt(inputDOMElement.value)

/*    - recuperare il valore della select */
        - richiamare la select
        const selectDomElement = document.getElementById('idSelect')
        - recuperare il value
